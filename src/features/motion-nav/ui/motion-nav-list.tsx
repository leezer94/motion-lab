...
import type { MotionNavListSection, MotionNavListItem } from "../types";
import { useMotionNavControls } from "../lib/use-motion-nav-controls";
...
export function MotionNavList({ sections }: MotionNavListProps) {
  const { openSections, toggleSection } = useMotionNavControls(sections);
